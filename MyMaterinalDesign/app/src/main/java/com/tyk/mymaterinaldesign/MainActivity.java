...
public class MainActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        fab_main_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar snackbar=Snackbar.make(cl_main_content,"热修复",Snackbar.LENGTH_SHORT).setAction("你点我试试", new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
    ...
    private void initRecyclerView() {
        ...
        rv_main_content.addItemDecoration(new RecyclerView.ItemDecoration() {
            @Override
            public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
                super.getItemOffsets(outRect, view, parent, state);
                outRect.bottom = -dp2px(MainActivity.this, 10);
            }
        });
                ...
                for (int i = firstPosition - 1; i <= (firstPosition + visibleCount) + 1; i++) {
                    ...
                    if (view != null) {
                        if (view instanceof CardView) {
                            ((CardView) view).setCardElevation(dp2px(MainActivity.this, elevation));
                            elevation += 5;
                        }
